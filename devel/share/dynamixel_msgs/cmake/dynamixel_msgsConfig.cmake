...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_msgs_SOURCE_PREFIX /home/bboo/Wait-Bot-X/src/dynamixel_motor/dynamixel_msgs)
  set(dynamixel_msgs_DEVEL_PREFIX /home/bboo/Wait-Bot-X/devel)
  ...
  set(dynamixel_msgs_INSTALL_PREFIX /home/bboo/Wait-Bot-X/install)
...
if(NOT "/home/bboo/Wait-Bot-X/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bboo/Wait-Bot-X/src/dynamixel_motor/dynamixel_msgs/${idir}'.  ${_report}")
    endif()
