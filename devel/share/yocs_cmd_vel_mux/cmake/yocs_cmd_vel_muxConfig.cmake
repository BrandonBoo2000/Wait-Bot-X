...
if("TRUE" STREQUAL "TRUE")
  set(yocs_cmd_vel_mux_SOURCE_PREFIX /home/bboo/Wait-Bot-X/src/yocs_cmd_vel_mux)
  set(yocs_cmd_vel_mux_DEVEL_PREFIX /home/bboo/Wait-Bot-X/devel)
  ...
  set(yocs_cmd_vel_mux_INSTALL_PREFIX /home/bboo/Wait-Bot-X/install)
...
if(NOT "/home/bboo/Wait-Bot-X/devel/include;/home/bboo/Wait-Bot-X/src/yocs_cmd_vel_mux/include " STREQUAL " ")
  set(yocs_cmd_vel_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/bboo/Wait-Bot-X/devel/include;/home/bboo/Wait-Bot-X/src/yocs_cmd_vel_mux/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_cmd_vel_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bboo/Wait-Bot-X/src/yocs_cmd_vel_mux/${idir}'.  ${_report}")
    endif()
