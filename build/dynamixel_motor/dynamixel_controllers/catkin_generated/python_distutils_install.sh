...
echo_and_run cd "/home/bboo/Wait-Bot-X/src/dynamixel_motor/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bboo/Wait-Bot-X/src/dynamixel_motor/dynamixel_controllers/setup.py" \
     \
    build --build-base "/home/bboo/Wait-Bot-X/build/dynamixel_motor/dynamixel_controllers" \
    install \
    --root="${DESTDIR-/}" \
